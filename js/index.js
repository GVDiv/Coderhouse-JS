class juego {
	...
	async iniciarJuego() {
		...
		for (let i = 0; i < this.dataAPI.data.info.count; i+=1) {
		...
		for (let i = 0; i < LengthStatic; i+=1) {
		...
		for (let i = 0; i < this.tarjetas.length; i+=1) {
